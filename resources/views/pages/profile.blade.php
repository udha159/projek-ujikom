...
@section('content')
    <section class="mt-32">
            <h3 class="text-5xl text-center font-hurricane">UBAH PROFIL</h3>
        </div>
    </section> 
    <section class="mt-10">
            ...
            <div class="bg-white rounded-md shadow-md">
                <form action="/updateprofile" method="POST">
                    ...
                    <div class="flex flex-col px-4 py-4 ">
                        ...
                        <h5>No Telepon</h5>
                        <input type="number" name="no_telepon" value="{{ $dataprofile->no_telepon }}"
                            class="py-1 rounded-md">
                        
                        <h5>Jenis Kelamin</h5>
                        <select name="jenis_kelamin" id="" class="py-1 rounded-md">
                            @if($dataprofile->jenis_kelamin == 'laki-laki')
                                <option value="{{ $dataprofile->jenis_kelamin }}">{{ $dataprofile->jenis_kelamin }}</option>
