...
@section('content')
    ...
    function previewImage(input) {
        ...
        // Memeriksa ukuran file (maksimal 800x400px)
                ...
                <div class="flex flex-wrap px-2 flex-container">
                            ...
                            <div class="flex items-center justify-center w-full">
                                <label for="dropzone-file"
                                    ...
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        <img id="preview-image" class="w-32 h-32 mb-4 object-cover" src=""
                                            alt="Preview Image">
                    ...
                    <div class="w-2/5 max-[480px]:w-full px-2">
                        ...
                        <div class="flex flex-col flex-wrap ">
                            ...
                            <div class="mb-3"></div>
                            <textarea name="deskripsifoto" id="" cols="30" rows="10"
