        ...
        <div class="flex flex-col items-center max-w-screen-md px-2 mx-auto mt-4">
            ...
            <div class="flex flex-row mt-3">
                <a href="follower.html">
                    <small class="mr-4 text-abuabu">1000 Pengikut</small>
                </a>
                <a href="follower.html">
                    <small class="text-abuabu">6 Mengikuti</small>
                </a>

            </div>
            <button class="px-4 mt-4 text-white bg-black rounded-full">Mengikuti</button>
        </div>
    </section>
    <section class="mt-10">
            ...
            <div class="flex flex-wrap justify-center gap-2">
                <div class="w-20">
                    <div class="flex flex-col items-center">
                        ...
                        <a href="other-pin.html">
                            <h5 class="mt-2 text-xs">OmenSoft</h5>
                        </a>
                ...
                <div class="w-20">
                    <div class="flex flex-col items-center">
                        <img src="/assets/users.png" alt="" class="w-14">
                        <a href="other-pin.html">
                            <h5 class="mt-2 text-xs">Aliyatun nisa</h5>
                        </a>
