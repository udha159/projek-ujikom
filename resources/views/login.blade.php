...
<body class="bg-black">
  <nav class=" border-3 bg-red-600 ">
    <div class="flex justify-between max-w-screen-md mx-auto py-3">
      ...
      <div>
        <button class=" inline bg-white px-4 py-1 rounded-full text-black font-extrabold"><a href="/register">REGISTER</a></button>
      </div>
    </div>
  </nav>
</div>
...
<div class="bg-pink-200 shadow-lg w-1/4 p-2 mx-auto mt-20 rounded-xl px-11 py-11">
  <h2 class="bg-white rounded-3xl font-fontutama text-4xl text-center">LOGIN</h2>
  @if ($message = Session::get('error'))
                <div id="alert" class="flex items-center p-1 m-1 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
...
<button class="bg-black px-4 py-1 rounded-full w-full mt-8 text-white">LOGIN</button>
</form>
</body>
</html>